...
Route::prefix('v1')->group(function () {
    ...
    Route::prefix('quizzes')->group(function () {
        ...
        Route::get('submission_status/{submissionId}', [Controller::class, 'check_submission_status']); // NEW STATUS ROUTE
        Route::post('debug_session', [Controller::class, 'debug_session']); // DEBUG ROUTE - REMOVE AFTER TESTING
